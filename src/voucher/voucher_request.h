 ...
 *
 * @param[in] serial_number The serial number string from the idevid certificate
 * @param[in] additional_registrar_certs The list of additional registrar certificates (DER format)
 ...
 * @param[in] masa_sign_cert The certificate buffer for signing (array in DER format) the masa voucher
 * @param[in] masa_sign_key The private key buffer of the certificate (array in DER
 * format)
