 ...
 * null terminated to make it easier to use as a C string. The null terminator is
 * not included in out_length.
 * 
 ...
 */
uint8_t *serialize_to_base64(const uint8_t *src, size_t length,
                             size_t *out_len);
